...
//         {
//             var Encontrado = _appContext.emailOperador.FirstOrDefault(p => p.emailOperadorId == del); //IdEmailOperador es la pk de EmailOperador.cs
//             if (Encontrado == null)
//                 return;
...
//         {
//             return _appContext.emailOperador.FirstOrDefault(p => p.emailOperadorId == get);// p.Priamry_key_de_la_entidad
//         }
//         EmailOperador IRepositorioEmailOperador.UpdateEmailOperador(EmailOperador up)
//         {
//             var Encontrado = _appContext.emailOperador.FirstOrDefault(p => p.emailOperadorId == up.emailOperadorId);
//             if (Encontrado != null)
//             {
