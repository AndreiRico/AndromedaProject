...
//         {
//             var Encontrado = _appContext.cuenta.FirstOrDefault(p => p.cuentaId == del); //Documento es la pk de USUARIO.cs
//             if (Encontrado == null)
//                 return;
...
//         {
//             return _appContext.cuenta.FirstOrDefault(p => p.cuentaId == get);
//         }
//         Cuenta IRepositorioCuenta.UpdateCuenta(Cuenta up)
//         {
//             var Encontrado = _appContext.cuenta.FirstOrDefault(p => p.cuentaId == up.cuentaId);
//             if (Encontrado != null)
//             {
